...
| `OPENSSL_cipher_name`  |  |  |  |  |
| `OPENSSL_init_ssl`  | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: |
...
| `SSL_COMP_get0_name`  |  |  |  |  |
| `SSL_COMP_get_compression_methods`  |  |  | :white_check_mark: |  |
| `SSL_COMP_get_id`  |  |  |  |  |
| `SSL_COMP_get_name`  |  |  |  |  |
| `SSL_COMP_set0_compression_methods`  |  |  |  |  |
| `SSL_CONF_CTX_clear_flags`  |  |  |  | :white_check_mark: |
| `SSL_CONF_CTX_finish`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
| `SSL_CONF_CTX_free`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
| `SSL_CONF_CTX_new`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
| `SSL_CONF_CTX_set1_prefix`  |  |  |  | :white_check_mark: |
| `SSL_CONF_CTX_set_flags`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
| `SSL_CONF_CTX_set_ssl`  |  |  |  | :white_check_mark: |
| `SSL_CONF_CTX_set_ssl_ctx`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
| `SSL_CONF_cmd`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
| `SSL_CONF_cmd_argv`  |  |  |  |  |
| `SSL_CONF_cmd_value_type`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
...
| `SSL_CTX_get0_certificate`  |  |  | :white_check_mark: | :white_check_mark: |
...
| `SSL_CTX_get_options`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
...
| `SSL_CTX_get_verify_callback`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
...
| `SSL_CTX_load_verify_dir`  | :white_check_mark: |  | :white_check_mark: | :white_check_mark: |
| `SSL_CTX_load_verify_file`  | :white_check_mark: |  | :white_check_mark: | :white_check_mark: |
...
| `SSL_CTX_set0_tmp_dh_pkey`  |  |  | :white_check_mark: |  |
...
| `SSL_CTX_set_client_cert_cb`  |  |  | :white_check_mark: |  |
...
| `SSL_CTX_set_default_passwd_cb`  | :white_check_mark: |  | :white_check_mark: | :exclamation: [^stub] |
...
| `SSL_CTX_set_post_handshake_auth`  | :white_check_mark: |  | :white_check_mark: | :exclamation: [^stub] |
...
| `SSL_CTX_set_srp_cb_arg` [^deprecatedin_3_0] [^srp] |  |  | :white_check_mark: |  |
...
| `SSL_CTX_set_srp_username_callback` [^deprecatedin_3_0] [^srp] |  |  | :white_check_mark: |  |
...
| `SSL_CTX_use_PrivateKey_file`  | :white_check_mark: |  | :white_check_mark: | :white_check_mark: |
...
| `SSL_CTX_use_certificate_chain_file`  | :white_check_mark: |  | :white_check_mark: | :white_check_mark: |
| `SSL_CTX_use_certificate_file`  | :white_check_mark: |  | :white_check_mark: | :exclamation: [^stub] |
...
| `SSL_SESSION_get_compress_id`  |  |  | :white_check_mark: |  |
...
| `SSL_SESSION_get_time`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
...
| `SSL_SESSION_set_timeout`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
...
| `SSL_accept`  |  |  | :white_check_mark: | :white_check_mark: |
| `SSL_add1_host`  |  |  |  |  |
| `SSL_add1_to_CA_list`  |  |  |  |  |
| `SSL_add_client_CA`  |  |  |  |  |
| `SSL_add_dir_cert_subjects_to_stack`  |  |  |  |  |
| `SSL_add_file_cert_subjects_to_stack`  |  |  | :white_check_mark: |  |
| `SSL_add_ssl_module`  |  |  |  |  |
| `SSL_add_store_cert_subjects_to_stack`  |  |  |  |  |
| `SSL_alert_desc_string`  |  |  |  | :white_check_mark: |
| `SSL_alert_desc_string_long`  | :white_check_mark: |  | :white_check_mark: | :white_check_mark: |
...
| `SSL_certs_clear`  |  |  |  |  |
| `SSL_check_chain`  |  |  |  |  |
| `SSL_check_private_key`  |  |  | :white_check_mark: | :white_check_mark: |
| `SSL_clear`  |  |  |  |  |
| `SSL_clear_options`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
...
| `SSL_client_version`  |  |  |  |  |
| `SSL_config`  |  |  |  |  |
| `SSL_connect`  | :white_check_mark: |  | :white_check_mark: | :white_check_mark: |
| `SSL_copy_session_id`  |  |  |  |  |
...
| `SSL_get_cipher_list`  |  |  |  |  |
| `SSL_get_ciphers`  |  |  | :white_check_mark: |  |
| `SSL_get_client_CA_list`  |  |  | :white_check_mark: | :exclamation: [^stub] |
...
| `SSL_get_fd`  |  |  |  |  |
| `SSL_get_finished`  |  |  | :white_check_mark: |  |
...
| `SSL_get_peer_finished`  |  |  | :white_check_mark: |  |
...
| `SSL_get_shared_ciphers`  |  |  | :white_check_mark: |  |
| `SSL_get_shared_sigalgs`  |  |  |  |  |
| `SSL_get_shutdown`  | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: |
| `SSL_get_sigalgs`  |  |  |  |  |
| `SSL_get_signature_type_nid`  |  |  |  |  |
| `SSL_get_srp_N` [^deprecatedin_3_0] [^srp] |  |  |  |  |
| `SSL_get_srp_g` [^deprecatedin_3_0] [^srp] |  |  |  |  |
| `SSL_get_srp_userinfo` [^deprecatedin_3_0] [^srp] |  |  | :white_check_mark: |  |
| `SSL_get_srp_username` [^deprecatedin_3_0] [^srp] |  |  | :white_check_mark: |  |
| `SSL_get_srtp_profiles` [^srtp] |  |  |  |  |
| `SSL_get_ssl_method`  |  |  |  |  |
| `SSL_get_state`  |  |  |  | :white_check_mark: |
| `SSL_get_verify_callback`  |  |  |  |  |
| `SSL_get_verify_depth`  |  |  | :white_check_mark: | :white_check_mark: |
| `SSL_get_verify_mode`  |  |  | :white_check_mark: | :white_check_mark: |
...
| `SSL_in_init`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
| `SSL_is_dtls`  |  |  |  |  |
| `SSL_is_init_finished`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
| `SSL_is_server`  |  |  | :white_check_mark: | :white_check_mark: |
| `SSL_key_update`  |  |  |  |  |
...
| `SSL_read_ex`  |  |  |  |  |
| `SSL_renegotiate`  |  |  | :white_check_mark: |  |
...
| `SSL_set_options`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
...
| `SSL_set_shutdown`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
| `SSL_set_srp_server_param` [^deprecatedin_3_0] [^srp] |  |  | :white_check_mark: | :exclamation: [^stub] |
...
| `SSL_state_string`  |  |  |  |  |
| `SSL_state_string_long`  |  |  | :white_check_mark: |  |
| `SSL_stateless`  |  |  |  |  |
| `SSL_test_functions` [^unit_test] |  |  |  |  |
| `SSL_trace` [^ssl_trace] |  |  |  |  |
| `SSL_up_ref`  |  |  |  | :white_check_mark: |
| `SSL_use_PrivateKey`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
...
| `SSL_use_certificate`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
| `SSL_use_certificate_ASN1`  |  |  |  |  |
| `SSL_use_certificate_chain_file`  |  |  |  |  |
| `SSL_use_certificate_file`  |  |  |  |  |
| `SSL_use_psk_identity_hint` [^psk] |  |  |  |  |
| `SSL_verify_client_post_handshake`  |  |  | :white_check_mark: |  |
| `SSL_version`  |  | :white_check_mark: | :white_check_mark: | :white_check_mark: |
